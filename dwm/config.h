...
static Key keys[] = {
    ...
    {0, XF86XK_AudioLowerVolume,           spawn, SHCMD("~/scripts/set_vol.sh down") },
    {0, XF86XK_AudioRaiseVolume,           spawn, SHCMD("~/scripts/set_vol.sh up") },
    
    {0, XF86XK_MonBrightnessUp,            spawn, SHCMD("light -A 10") },
    {0, XF86XK_MonBrightnessDown,          spawn, SHCMD("light -U 10") },

    /* spawn + SHCMD 执行对应命令(已下部分建议完全自己重新定义) */
    { MODKEY,              XK_s,      togglescratch, SHCMD("alacritty -t scratchpad -c float") },                      /* super s          | 打开scratch终端        */
